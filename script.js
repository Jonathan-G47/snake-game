...
const directionEvent = event => {
    ...
    if (key === 'ArrowUp' && direction !== 'ArrowDown') direction = 'ArrowUp';
    if (key === 'ArrowDown' && direction !== 'ArrowUp') direction = 'ArrowDown';
    if (key === 'ArrowLeft' && direction !== 'ArrowRight') direction = 'ArrowLeft';
    if (key === 'ArrowRight' && direction !== 'ArrowLeft') direction = 'ArrowRight';
};
